...
module.exports = require("@neon-rs/load").proxy({
    platforms: {
        "win32-x64-msvc": () => require("@scatter-net/win32-x64-msvc"),
        "darwin-x64": () => require("@scatter-net/darwin-x64"),
        "darwin-arm64": () => require("@scatter-net/darwin-arm64"),
        "linux-x64-gnu": () => require("@scatter-net/linux-x64-gnu"),
        "linux-arm64-gnu": () => require("@scatter-net/linux-arm64-gnu"),
    },
